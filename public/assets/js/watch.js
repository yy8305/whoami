(function(g, k, A) {
  ...
  function wb(a, b, c, d, f) {
    ...
    function Q(a) {
      ...
      R && (d |= 2);
      a: {
        var v = p.getElementChildren(p.getElementParent(a), a.tagName);
        for (var k = 0; k < v.length; k++)
          if (
            (!v[k].id || "string" != typeof v[k].id) &&
            p.calcAttribChecksum(v[k]) == R &&
            p.calcTextChecksum(v[k]) == f
          ) {
            v = !0;
            break a;
          }
    ...
    function r(a, b, c, d, f, e) {
      ...
      h(c, a);
      h(c, q);
      h(c, Math.max(0, d[0] - g[0]));
      h(c, Math.max(0, d[1] - g[1]));
      /^mouse(up|down)|click$/.test(b) &&
        ((a = f || e), n(c, 2 > a ? 1 : a == (f ? 2 : 4) ? 4 : 2));
      return c;
    }
    function Ab(a, b, c, d) {
      b = b[F];
    ...
    function E(a) {
      ...
      for (
        var f = -1, e = a.form.elements, q = e.length, g = 0, x = 0;
        g < q;
        g++
      )
        if (e[g].name == a.name) {
        ...
        a: {
          ...
          if (0 < c) {
            ...
            var f = W[c],
              ...
              q = a[2] + "x" + a[3];
            e != f.pos &&
              ((f.pos = e), n(d, 9), h(d, b), h(d, c), h(d, a[0]), h(d, a[1]));
            q != f.size &&
              ((f.size = q),
              n(d, 10),
              h(d, b),
    ...
    function P(a, b) {
      ...
      b &&
        ...
        (c =
          c ||
          !!p.getElementsByClassName("(ym-disable-keys|-metrika-nokeys)", a)
            .length);
      return c;
    }
    function T(a) {
    ...
    function ea() {
      var a = p.getDocumentScroll(),
        b = m.nowTime();
      10 > b - lb ||
        (10 > Math.abs(a[0] - cb[0]) && 10 > Math.abs(a[1] - cb[1])) ||
        ((lb = b), (cb = a), G(za, [m.nowEventTime(), a]));
    }
    function da(a) {
      if ((a = B.getTarget(a))) {
        var b = Math.random(),
    ...
    function J(a) {
      ...
      var b = "password" === a.type || Ra.test(a.name) || Ra.test(a.id),
        c =
          e.reduce(
            function(b, c) {
            ...
            !1,
            ["className", "id", "name"]
          ) || Ea.placeholderRegex.test(a.placeholder),
    ...
    function ha(a, b, c) {
      ...
      var d = J(a);
      d.ignore ||
        (!d.forceRecord && ((d.isPrivate && f.get("isEU")) || P(a))) ||
        (O(a), G(A, [m.nowEventTime(), b, c, a, d.privateFlag]));
    }
    function Y(a) {
      var b = a.keyCode,
        c = la(a);
    ...
    function ma(a) {
      U &&
        !eb &&
        0 !== a.which &&
        (ha(a, a.charCode || a.keyCode, la(a)),
        (eb = !0),
        e.setTimeout(
          function() {
            eb = !1;
    ...
    function oa() {
      if (g.getSelection) {
        ...
        k.selection &&
          k.selection.createRange &&
          ((a = k.selection.createRange()),
          (b = a.text),
          (c = a.parentElement()));
      if ("string" == typeof b) {
        try {
    ...
    var ta = new Sa({
        ...
        counterId: b,
        counterType: c,
        meta: { url: y().href, hitId: d, timezone: Ga, timestamp: Ha }
      }),
      mb = p.getBody(),
      yb = {
        A: 1,
    ...
    var F = "metrikaId_" + Math.random(),
      W = {},
      S = ":submit" + Math.random();
    if (!e.isMetrikaPlayer()) {
      l.on(k, "mousemove", D);
      l.on(k, "click,dblclick,mousedown", N);
      l.on(k, "mouseup", Z);
      l.on(g, "scroll", ea);
      if ("onmousewheel" in k) l.on(k, "mousewheel", H);
      else l.on(k, "wheel", H);
      ...
      k.attachEvent && !g.opera
        ? (l.on(k, "focusin", na), l.on(k, "focusout", fa))
        : (l.on(g, "focus", ja), l.on(g, "blur", pa), l.on(k, "blur", pa));
      k.addEventListener
        ? (l.on(k, "scroll", da),
          l.on(k, "focus", R),
          l.on(k, "blur", v),
        ...
        : k.attachEvent &&
          ...
          (function() {
            for (
              var a = k.getElementsByTagName("form"), b = 0;
              b < a.length;
              b++
            ) {
              for (
    ...
    return {
      ...
      uploadPages: function(a, b) {
        ...
        "complete" === k.readyState
          ? c()
          : (l.on(k, "DOMContentLoaded", c), l.on(g, "load", c));
      },
      uploadPage: w(function(f) {
        if (
          "function" === typeof g.toStaticHTML &&
          -1 < g.toStaticHTML.toString().indexOf("NoScript")
        )
          return !1;
        ...
        var e = g.XMLHttpRequest
          ...
          h = p.getDocumentCharset(),
          q = "text/html" + (h ? ";charset\x3d" + h : ""),
        ...
        if ("html" === f)
          return (
            (f = new RegExp(
              "\x3cscript [^\x3e]*?//" +
                C.host.replace(/\./g, "\\\\.") +
                "/watch/.*?\x3c/script\x3e",
              "gi"
            )),
            x.sendContent(p.getDocumentHTML().replace(f, ""), q, d, Ga, Ha),
            !0
          );
        e &&
          (e.open("get", y().href, !0),
          (e.onreadystatechange = w(function() {
            if (4 === e.readyState) {
          ...
          e.overrideMimeType && h && e.overrideMimeType(q),
          e.send(null));
        return !0;
      }, "uploadPage")
    };
  ...
  function fa() {
    return (
      0 ==
      y().hostname.search(
        /^(.*\.)?((yandex(-team)?)\.(com?\.)?[a-z]+|(auto|kinopoisk|beru|bringly)\.ru|ya\.(ru|cc)|yadi\.sk|yastatic\.net|.*\.yandex)$/
      )
    );
  }
  function ua(a) {
    ...
    if (Y) {
      var va = (function(a) {
        ...
        return (
          ...
          (b.o = function(a, c, e) {
            b.D(a, c) ||
              Object.defineProperty(a, c, { enumerable: !0, get: e });
          }),
          (b.C = function(a) {
                  ...
                  q &&
                    (b.push(
                      "webgl unmasked vendor:" +
                        a.getParameter(q.UNMASKED_VENDOR_WEBGL)
                    ),
                    b.push(
          ...
          b.hash = function(a, b) {
            ...
            for (
              ...
              (l = [
                ...
                (l = f((l = c(l, t)), 31)),
                (k = d((k = f((k = g(k, c(l, p))), 27)), b)),
                (k = d(c(k, [0, 5]), [0, 1390208809])),
                (x = f((x = c(x, p)), 33)),
                (b = d((b = f((b = g(b, c(x, t))), 31)), k)),
            ...
            switch (((l = [0, 0]), (x = [0, 0]), q)) {
              ...
              case 9:
                (x = c((x = g(x, [0, a.charCodeAt(m + 8)])), p)),
                  (b = g(b, c(f(x, 33), t)));
              case 8:
              ...
              case 1:
                (l = c((l = g(l, [0, a.charCodeAt(m)])), t)),
                  (k = g(k, c(f(l, 31), p)));
            }
            return (
              (k = d((k = g(k, [0, a.length])), (b = g(b, [0, a.length])))),
              (b = d(b, k)),
              (k = d((k = h(k)), (b = h(b)))),
              (b = d(b, k)),
  ...
  e.setTimeout = function(a, b, c) {
    return e.getNativeFunction("setTimeout")(w(a, c || "setTimeout"), b);
  };
  var l = E.inherit({
    ...
    on: function(a, b, c, d, f) {
      ...
      for (h = 0; h < e; h++) {
        ...
        a.addEventListener
          ? a.addEventListener(k, m, l._prepOpts(f))
          : a.attachEvent && a.attachEvent("on" + k, m);
      }
    },
  ...
  m.isPerfomance ||
    ...
    (m.lastNowTime = 0),
    (m.correctTime = 0),
    (m.timeCorrector = function(a) {
      m.correctTime = m.getMs();
      a &&
        m.correctTime < m.lastTime &&
        (m.deltaTime += a - m.correctTime + 20);
      e.setTimeout(
        function() {
  ...
  var Ia = E.inherit({
      ...
      _initComponent: function() {
        ...
        this.storage &&
          ...
          a.meta &&
          a.time &&
          a.time + this.bufferExpireTime > +m.getMs() &&
          this.onFlush.call(
  ...
  ka.stringify = function(a, b) {
    var c = [],
      ...
      h;
    if (d.lastOrdering !== A)
      for (h = 1; h <= b.lastOrdering.length; h++)
        f[b.lastOrdering[h - 1]] = g + h;
    if (d.firstOrdering !== A)
      for (h = 0; h < b.firstOrdering.length; h++) f[b.firstOrdering[h]] = h;
    for (n in a)
      if (a.hasOwnProperty(n))
        if (((d = a[n]), e.isArray(d)))
          for (h = 0; h < d.length; h++)
            c.push({
              ...
              value:
                ...
                "\x3d" +
                encodeURIComponent(String(d[h]))
            });
        else
          c.push({
            key: n,
            value:
              encodeURIComponent(n) + "\x3d" + encodeURIComponent(String(d))
          });
    c.sort(function(a, b) {
      var c = f[a.key],
        d = f[b.key];
  ...
  Y = U.inherit({
    ...
    request: function(a, b, c, d) {
      ...
      if (
        ...
        if ("string" === typeof n && "12" === n.split(".")[0])
          return c.call(d, !1);
      }
      if (g.XMLHttpRequest) {
    ...
    request: function(a, b, c, d) {
      ...
      navigator.onLine
        ? ((b = this._splitParams(b)),
          ...
          c.call(
            d,
            navigator.sendBeacon(this._buildUrl(a, b.get), ka.stringify(b.post))
          ))
        : c.call(d, !1);
    }
  });
  ...
  var W = U.inherit({
      ...
      _initComponent: function() {
        ...
        "_htmlfile" in W.prototype ||
          (W.prototype._htmlfile = this._createHtmlfile());
    ...
    Jb = W.inherit({ id: "htmlfile", index: 3, htmlfileOnly: !0 }),
    S = U.inherit({
      id: "img",
      index: 4,
      request: function(a, b, c, d) {
  ...
  var P = {
      ...
      tailSafe: "*-_",
      encode: function(a, b) {
        var c = (P.abc + (b ? P.tailSafe : P.tail)).split(""),
          d = a.length,
          f = [],
          g = d - (d % 3),
          n;
      ...
      decode: function(a, b) {
        for (
          var c = P.abc + (b ? P.tailSafe : P.tail),
            d = 0,
            f = "",
            e,
            g,
  ...
  var ha = {
      ...
      checkVersion: function() {
        ...
        return (
          !((r.isIOS() || (10 <= a[0] && 13 <= a[2])) && r.isSafari()) ||
          r.isSafariWebView()
        );
      },
      noop: function() {},
      ...
      genYm: function(a) {
        ...
        if (
          ...
          fetch("//" + f + "/daiku", { credentials: "include" })
            .then(function(a) {
              return a.json();
            })
            .then(function(c) {
      ...
      initZZ: function() {
        ...
        this.getZZ() ||
          (this.checkVersion() && !b) ||
          (b && (a = "md"),
          (b = e.getNativeFunction("createElement", k)("iframe")),
          (b.style.display = "none"),
          (b.style.width = "1px"),
          (b.style.height = "1px"),
          (b.style.visibility = "hidden"),
          (b.src = C.protocol + "//" + C.baseUrl + a + P.decode(C.cross)),
  ...
  L.initCookie = function(a) {
    var b = new I({ onlyCurrentDomain: a !== C.cookieName }),
      c = b.read(a),
      d = L._storage.get(a),
      f = !1,
      g = b.read("d"),
    ...
    d &&
      !c &&
      ((c = d), (f = !0), b.create(a, c, 525600), b.create("d", n, 525600));
    if (!c)
      (c = n + "" + e.random()),
        b.create(a, c, 525600),
        b.create("d", n, 525600);
    else if (!g || 15768e3 < n - parseInt(g))
      b.create(a, c, 525600), b.create("d", n, 525600);
    L._storage.set(a, c);
    L._userID = c;
    return f;
  };
  ...
  p.getBody = function() {
    for (var a = k.getElementsByTagName("body"); 0 < a.length; ) return a[0];
  };
  ...
  p.getDocumentTitle = function() {
    ...
    "string" != typeof a &&
      (a =
        (a = k.getElementsByTagName("title")) && a.length
          ? a[0].innerHTML
          : "");
    return a;
  };
  ...
  var Ja = L.inherit({
    ...
    _hitExt: function(a, b) {
      ...
      if (!e.isMetrikaPlayer()) {
        ...
        var k = a.browserInfo || {};
        var l =
          "undefined" !== typeof a.referrer ? a.referrer : Va.lastReferrer;
        var m = a.url || "";
        var p = {};
        a.nohit && c("nohit", 1);
        h.ar &&
        ...
        -1 != y().hostname.search(/(?:^|\.)(?:ya|yandex)\.(?:\w+|com?\.\w+)$/)
          ? c("ut", hb)
          : "undefined" != typeof h.ut && c("ut", e.trim(h.ut, Kb));
        c("exp", a.experiments);
        (f = a.vParams) &&
          this.counter &&
          f.__ym &&
    ...
    _getTechInfo: function(a, b, c, d, f, k, n, h, l, t) {
      ...
      ia &&
        q(
          "s",
          ia.width + "x" + ia.height + "x" + (ia.colorDepth || ia.pixelDepth)
        );
      g.devicePixelRatio && q("sk", g.devicePixelRatio);
      r.isSelenium() && q("iss", "1");
      r.isHeadLess() && q("hdl", "1");
      r.isIframe() &&
        (q("ifr", "1"), q("sti", r.isSameOriginTopFrame() ? "1" : "0"));
      g.ia_document &&
      ...
      e.random(100) ||
        q("np", P.encode(oa.encode(e.trim(r.getPlatform(), 100))));
      k && q("wh", "1");
      ...
      if (h) {
        n = u.get("winNameNum");
        if (!n) {
          if ((n = +g.name || Math.round(65535 * Math.random())))
            0 > n && (n *= -1), (n %= 65535);
  ...
  var Pa = E.inherit({
    ...
    Mb = L.inherit({
      ...
      retry: !0,
      postParams: ["wv-data"],
      sendPacket: function(a, b, c, d, f, q, n, h) {
        if (!a || !a.length) return !1;
        var k = P.encode(a, !0);
        if (0 == k.indexOf("AAAAAAAAADw") && g.Error) {
          var l = Error();
          "string" == typeof l.stack &&
            new Pa({ sampling: 0.1 }).log("bad visor packet 5", 1);
        }
        a = {
          rn: e.random(),
          "page-url": b,
    ...
    Db = L.inherit({
      ...
      sendContent: function(a, b, c, d, f, e, g) {
        ...
        a = {
          ...
          "page-url": y().href,
          "wv-hit": c,
          "wv-data": P.encode(oa.encode(a))
        };
        return 245e3 < a["wv-data"].length
          ? !1
          : this.send(a, { z: d, i: f, pct: b || "" }, e, g);
      }
    });
  ...
  p.getDocumentScroll = function() {
    ...
    return [
      g.pageXOffset ||
        (k.documentElement && k.documentElement.scrollLeft) ||
        (a && a.scrollLeft) ||
        0,
      g.pageYOffset ||
        (k.documentElement && k.documentElement.scrollTop) ||
        (a && a.scrollTop) ||
        0
    ];
  };
    ...
    if (a && (d = a.childNodes)) {
      ...
      for (g = d.length; n < g; n++) {
        ...
        (f =
          "INPUT" == h.nodeName &&
          h.type &&
          "hidden" == h.type.toLocaleLowerCase()) ||
          (b && h.nodeName != b) ||
          e.mergeArrays(c, [h]);
      }
    }
  ...
  p.getElementSize = function(a) {
    var b;
    return a == p.getBody() || a == k.documentElement
      ? p.getDocumentSize()
  ...
  var Cb = !ua(/webkit/) && ua(/gecko/),
    rb = E.inherit({
          ...
          "w" === b
            ? (this._recorder.start(),
              ...
              (a = a.urls) &&
                c &&
                "none" !== c &&
                this._recorder.uploadPages(a, c))
            : this._recorder.stop();
        }
      },
      stop: function() {
      ...
      _getStorage: function() {
        this._storage || (this._storage = new I({ counterId: this.counterId }));
  ...
  wa = U.inherit({
    ...
    request: function(a, b, c, d) {
      var f = !1,
        q = e.getNativeFunction("createElement", k)("script");
      this.timeout &&
        e.setTimeout(
          function() {
  ...
  var La = Y.inherit({
    ...
    ib = Ja.inherit({
      ...
      sendHit: function(a) {
        ...
        c &&
          ...
          (b.ilt = P.encode(oa.encode(e.trim(c, sb)))));
    ...
    Ma = E.inherit({
      ...
      hit: function(a, b) {
        ...
        f && f.params && f.time + 864e5 > m.getMs()
    ...
    tb = E.inherit({
      ...
      _syncAdmetrica: function() {
        var a = C.protocol + "//" + C.admetrikaUrl,
          b = new S({}),
          c = this._getLs();
        ((c.get("synced") || {}).SYNCED_ADM || 1) + 1440 < m.getMinutes() &&
          b.request(a + "/sync_cookie_image_check", {}, function(a) {
            c.get("synced");
            var b = m.getMinutes();
            a || (b -= 1435);
            a = c.get("synced") || {};
        ...
        if (0 < e) {
          ...
          for (c = 0; c < e; c++)
            (function(a) {
              l.request(
                f +
                  (g._replaceBase[a] ? a : g.baseUrl + a) +
      ...
      _getCn: function() {
        this._cn ||
          (this._cn = new Ma({ fake: !0, globalConfig: this.globalConfig }));
        return this._cn;
      },
      _getLs: function() {
  ...
  var Na = {
      ...
      save: function(a, b) {
        this._getReq().request(
          this._url + ka.stringify({ key: a, value: e.toJSON(b) })
        );
        this._getLs().set(a, b);
      },
      get: function(a) {
        ...
        try {
          if ((b = a.target || a.srcElement))
            !b.ownerDocument && b.documentElement
              ? (b = b.documentElement)
              : b.ownerDocument !== k && (b = null);
        } catch (c) {}
        return b;
      },
      getMouseButton: function(a) {
        return a.which || a.button == A
          ? a.which
          : a.button & 1
          ? 1
          : a.button & 2
  ...
  B.dispatchCustomEvent = w(function(a, b) {
    var c;
    b = b || k;
    if ((c = e.getNativeFunction("createEvent", k)("Event")))
      c.initEvent(a, !1, !1), e.getNativeFunction("dispatchEvent", b)(c);
  }, "evt.dispatch");
  var Va = { lastReferrer: null },
    ja = E.inherit({
      counter: null,
      prefsEcommerce: null,
            ...
            if ("params" === n.type && n.data) {
              ...
              n.status == this.status.NEW &&
                ...
                (this.frameConnector.sendToParents(
                  { type: "params", data: n.data },
                  function() {
                    n.status = this.status.OK;
                  },
                  this
                ),
                (n.status = this.status.PENDING));
            }
          }
          if (d && d.ecommerce) {
            var h = {};
  ...
  var Pb = {
      ...
      addAsyncItem: function(a, b, c, d, f) {
        ...
        c
          ...
          : m.getMs() - this.rest >= this.restTime && !this.timeout
          ? ((this.rest = m.getMs()), g.flushAsync())
          : this.timeout ||
      ...
      callByTimeout: function(a, b) {
        for (
          var c = m.getMs(), d = 0, f, g = (b || 0) + 1, k = 0, h = this;
          ...
          if (
            ...
            !f.isExecuted &&
              ...
              (d = m.getMs() - c),
              (f.isExecuted = !0),
              !a && (k >= this.asyncChunk || d >= this.maxDuration)))
          ) {
            e.setTimeout(function() {
              h.callByTimeout(a, g);
            }, this.restTime);
      ...
      handle: function() {
        ...
        if (
          ...
          ("0" === k ||
            r.isSafariWebView() ||
            r.isAndroidWebView() ||
            e.inArray(Qb, g.location.href.split("?")[0]) ||
            !fa() ||
            f.read("yandex_login") ||
            this.disable)
        )
          return (
            f.read("yandex_login")
              ...
              ? "0" === k
                ...
                : r.isSafariWebView() || r.isAndroidWebView()
        ...
        a.hit(function(a) {
          if (a.params.eu || l || h.enabled)
            if (
              (h.frameConnector &&
                h.frameConnector.addHandler("isYandex", function() {
                  return { type: "isYandex", isYandex: fa() };
                }),
              h.frameConnector.isIframe)
            ) {
              h.frameConnector.sendToParents({ type: "isYandex" }, function(
                a,
                c
              ) {
                var d = !1;
                clearTimeout(g);
                c[0].isYandex
                  ? (h.trigger("GDPR-frame-ya"),
                    h.frameConnector.addHandler("GDPR-ok", function() {
                      d ||
                        (f.create("gdpr", "0", 525600),
                        h.realise(c, b),
                        (d = !0));
            ...
            } else h.askGDPR(k, d, c, p, b, f);
          else
            return (
              a.params.eu
                ? h.trigger("GDPR-skip-eu-na")
                : h.trigger("GDPR-eu-skip"),
              h.realise(p, b)
            );
        });
      }
  ...
  da.getState = function(a) {
    ...
    a = e.reduce(
      function(a, b) {
        b.ymetrikaEvent &&
          e.inArray(Xa, b.ymetrikaEvent.type) &&
          a.push(e.arrayIndexOf(Xa, b.ymetrikaEvent.type));
        return a;
      },
      [],
      a.get("dataLayer")
  ...
  T._check = w(function() {
    return (
      ...
      g._ym_debug ||
      "1" === T._cookie.read("debug")
    );
  });
  T.enabled = T._check();
  T.log = w(function() {
    (-1 < M.href.indexOf("_ym_debug\x3d1") || g._ym_debug) &&
      this._cookie.create("debug", "1");
    g.console &&
      console.log &&
      this._check() &&
      ((T.enabled = !0), console.log.apply(console, arguments));
  }, "DebugConsole.log");
  var Sb = L.inherit({
      resource: "clmap",
      retry: !0,
    ...
    Oa = E.inherit({
        ...
        e.forEachKey(
          ...
          function(c) {
            if (
              ...
              I.get(this.ASSESSOR_COOKIE + c)
            )
              I.set(this.ASSESSOR_COOKIE + c), a.push(b[c]);
          },
          this
        );
        return a;
      ...
      _buildRemoteIframe: function(a) {
        var b = e.getNativeFunction("createElement", k)("div"),
          c = p.getBody() || k.documentElement;
        if (c) {
          b.innerHTML =
      ...
      _isAllowedStatic: function(a) {
        return /^(([\w\-.]+\.)?dev\.webvisor\.com|yastatic\.net|[\w\-.]+\.s3\.yandex\.net)$/.test(
          a
        );
      },
      ...
      (function(a) {
        ...
        4: function(a, b, c) {
          ...
          b.detectAd = function() {
            var a = g.pageYOffset || m.scrollTop || h.scrollTop,
              b = g.pageXOffset || m.scrollLeft || h.scrollLeft,
              c = m.clientTop || h.clientTop || 0,
              k = m.clientLeft || h.clientLeft || 0,
              n = m.scrollWidth || m.offsetWidth || g.innerWidth,
              q = m.scrollHeight || m.offsetHeight || g.innerHeight,
            ...
            r.forEach(function(a) {
              ...
              a.forEach(function(a) {
                var b = a.element;
                u.push({ provider: a.provider, element: c ? e : b });
              });
            });
        ...
        9: function(a, b, c) {
          ...
          b.getAdsInWindow = function(a, b) {
            ...
            var f = b.isInIFrame,
              g = a.document.body,
              k = d.listToArray(g.querySelectorAll("img")),
              l = d.listToArray(g.querySelectorAll("iframe")),
              n = d.listToArray(g.querySelectorAll("script")),
  ...
  var Vb = {
      init: function(a, b) {
        if (Math.random() < (b || 0.005) && !u.get("adDetect")) {
          u.set("adDetect", !0);
          var c = function(b) {
    ...
    return w(function() {
        ...
        for (c = 0; c < f.length; c++) {
          ...
          if (b.match(g))
            if (((g = a.params || []), g.length)) {
              var h = e.safeDecodeURIComponent(
                (RegExp.$1 || "").replace(/\+/g, "%20")
              );
              for (d = 0; d < g.length; d++)
                if (h == e.safeDecodeURIComponent(g[d])) return !0;
            } else return !0;
        }
        return !1;
      }
      function n(a, b) {
        ...
        if (a && "string" != typeof a && a.length)
          for (d = 0; d < a.length; d++) {
            ...
            e = e.slice(1);
            if ("#" == g) {
              if ((g = k.getElementById(e)))
                (c = !0), b && Da.unshift([g, g.innerHTML]), (g.innerHTML = f);
            } else if ("." == g)
      ...
      function E() {
              ...
              callback: function(v, R) {
                ...
                if (!f.isDestructing()) {
                  ...
                  if (r) {
                        ...
                        for (X = 0; X < K.length; X++) {
                          ...
                          if ("ref" == t.type) t = q(t);
                            ...
                            for (H = 0; H < B.length; H++)
                              E["utm_" + B[H]] && (qa[B[H]] = E["utm_" + B[H]]);
                            var F = ca
                              ? "direct.yandex.ru"
                              : (D && D.service) || qa.source;
                            H = !1;
                            if (!H && y && y.length)
                            ...
                            if (!H && !w.yandex_direct && z && z.length)
                            ...
                            if (
                              ...
                              ((H = !1),
                              (ca =
                                ca || (D && D.campaign) || (qa && qa.campaign)))
                            )
                          ...
                          if (t) {
                            K[X].track_id &&
                              p.create("mp2_track", K[X].track_id, 43200);
                            break b;
                          }
                        }
                    }
                    ...
                    K && r
                      ? (p.create("mp2_substs", e.toJSON(r)),
                        (p = n(r)),
                        f.params(
                          "__ym",
                          p ? "mp_trackid" : "mp_trackid_bad",
                          K
                        ))
                      : h();
                  } else h();
        ...
        0 != e.keys(z).length &&
          ...
          z.enableAll
            ? (S(!0), U(!0), ia())
            : (z.clickmap && U(z.clickmap),
              z.trackLinks && S(z.trackLinks),
              z.accurateTrackBounce && ia(z.accurateTrackBounce)),
          z.triggerEvent &&
            e.async(
              function() {
        ...
        if (f._trackLinks && f._trackLinks.on) {
          ...
          if (c && !p.classNameExists(a, "ym-disable-tracklink")) {
            ...
            if (p.classNameExists(a, "ym-external-link"))
              J.sendClickLink({ url: c, title: h, modes: d }, D);
            else {
              var k = z.url ? e.parseUrl(D).hostname : y().hostname;
              d.dl = vb.test(g) || vb.test(c) || ob(c, ma) || ob(g, ma);
              b = b.hostname;
      ...
      function ia(b) {
        var c = z.referrer ? ea : k.referrer,
          d = z.url ? D : y().href;
      ...
      if (!g["disableYaCounter" + a]) {
        ...
        if (u.get("counters")[V])
          return (
            T.log("Duplicate counter " + V + " initialization"),
            u.get("counters")[V]
          );
        var aa = u.get("hitId");
        ...
        wa = 24226447 == a ? 1 : 0.002;
        f.replacePhones = t(function() {
          var b, c;
          try {
            (b = new I({ counterId: a }).read("mp2_substs")) &&
              (c = Z.parse(b)) &&
              n(c, !0);
          } catch (K) {}
          return f;
        ...
        f.params = t(function(b) {
          ...
          if (b) {
            ...
            (d =
              ...
              ? T.log('Set user id "' + g[0].__ym.user_id + '"')
              : T.log(
                  (c ? "User p" : "P") + "arams. Counter " + a + ". Params: ",
                  g[0]
                );
            J.sendParams(g[0], h, k, z.url ? D : y().href);
        ...
        f.destruct = t(function() {
          ...
          try {
            delete g["yaCounter" + a],
              delete u.get("counters")[V],
              delete u.get("hitParam")[V];
          } catch (R) {}
        });
        ...
        if (a) {
          ...
          if (
            "prerender" === k.webkitVisibilityState ||
            "prerender" === k.visibilityState
          ) {
            J.sendPrerenderHit({
              url: D,
              vParams: b,
            ...
            var Oa = function() {
              "prerender" !== k.webkitVisibilityState &&
                "prerender" !== k.visibilityState &&
                (l.un(k, "webkitvisibilitychange,visibilitychange", Oa), W(!0));
            };
  ...
  g.Ya.Metrika.informer = function(a) {
    ...
    b ||
      p.loadScript({ src: "https://informer.yandex.ru/metrika/informer.js" });
  };
  l.on(
    k,
    "click",
